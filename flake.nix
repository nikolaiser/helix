  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        helix-cogs = craneLibStable.buildPackage (
          commonArgs
          // {
            pname = "helix-cogs";
            version = "0.1.0";
        ...
        makeOverridableHelix =
          ...
          // {
            ...
            passthru = helix-wrapped.passthru // {
      ...
      {
        packages = {
          helix-unwrapped = craneLibStable.buildPackage (
            commonArgs
            // {
              cargoArtifacts = craneLibStable.buildDepsOnly commonArgs;
              postInstall = ''
        ...
        checks = {
          ...
          clippy = craneLibMSRV.cargoClippy (
            commonArgs
            // {
